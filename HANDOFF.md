...
nextAction: Design review batch 6 (F2/F3 Worker+D1, stop before deploy/migration) on branch design/granskning, see top section
blockers: []
...
- Kvar efter batch 5: batch 6 (F2/F3 Worker+D1, stoppa och fråga före deploy/migration), F4 (48 bilder via Codex CLI `codex`, finns installerad).
