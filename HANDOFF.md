...
- **Batch 1 klar** (`959e307`): fas 0 i PRODUCT.md, T1, T2, T3, T5. **T4 flyttad till batch 3**: utan förvalt läge går nivå 1 inte att välja med reglaget, knapparna i T14 löser det. **T6 ej gjord**: `signInWithRedirect` med authDomain `sipdeck.firebaseapp.com` på `buildapp.se` fallerar i webbläsare som blockerar tredjepartslagring (Firebase redirect best practices); kräver att `/__/auth` serveras på egen domän, zonarbete, ägarbeslut. **T5**: "GitHub Pages" står kvar, det är faktisk drift.
