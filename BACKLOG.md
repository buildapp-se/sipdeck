...
- [ ] `[P3]` "INPUT" 16 px (med luft runt, klarar WCAG). Decimalkontrollen (Postel) kräver `--interact` mot en lokal eller demo-instans, aldrig produktion med riktiga användare.
